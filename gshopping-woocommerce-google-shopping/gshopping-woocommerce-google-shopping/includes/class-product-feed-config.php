...
class Product_Feed_Config {
	...
	public function __construct() {
		...
		$this->attributes = array(
			...
			"installment"                   => array(
				...
				"element"     => array(
					"months" => array(
						...
						"placeholder" => esc_html__( "Months", 'gshopping-wc-google-shopping' ),
						"type"        => "number",
						"level"       => 1,
						"required"    => true,
					),
			...
			"subscription_cost"             => array(
				...
				"element"     => array(
					"period"        => array(
						...
						"placeholder" => esc_html__( "Period", 'gshopping-wc-google-shopping' ),
						"type"        => "select",
						"level"       => 1,
						"required"    => true,
						"option"      => array(
					...
					"period_length" => array(
						...
						"placeholder" => esc_html__( "Period length", 'gshopping-wc-google-shopping' ),
						"type"        => "number",
						"level"       => 1,
						"required"    => true,
					),
			...
			"loyalty_points"                => array(
				...
				"element"     => array(
					"name"         => array(
						...
						"placeholder" => esc_html__( "Name", 'gshopping-wc-google-shopping' ),
						"type"        => "text",
						"level"       => 1,
						"required"    => false,
					),
					"points_value" => array(
						...
						"placeholder" => esc_html__( "Points value", 'gshopping-wc-google-shopping' ),
						"type"        => "float",
						"level"       => 1,
						"required"    => true,
					),
					"ratio"        => array(
						...
						"placeholder" => esc_html__( "Ratio", 'gshopping-wc-google-shopping' ),
						"type"        => "float",
						"level"       => 1,
						"required"    => false,
					),
			...
			"product_detail"                => array(
				...
				"element"     => array(
					"section_name"    => array(
						...
						"placeholder" => esc_html__( "Section name", 'gshopping-wc-google-shopping' ),
						"type"        => "text",
						"max"         => 140,
						"level"       => 1,
						"required"    => false,
					...
					"attribute_name"  => array(
						...
						"placeholder" => esc_html__( "Attribute name", 'gshopping-wc-google-shopping' ),
						"type"        => "text",
						"max"         => 140,
						"level"       => 1,
						"required"    => true,
					...
					"attribute_value" => array(
						...
						"placeholder" => esc_html__( "Attribute value", 'gshopping-wc-google-shopping' ),
						"type"        => "text",
						"max"         => 1000,
						"level"       => 1,
						"required"    => true,
			...
			"custom_label_0-4"              => array(
				"support"     => "6324473",
				"title"       => esc_html__( "Custom label 0-4", 'gshopping-wc-google-shopping' ),
				"required"    => false,
				...
				"max"         => 100,
				"level"       => 0,
				"placeholder" => "Seasonal Clearance Holiday Sale Price range",
			),
			"promotion_id"                  => array(
				"support"     => "7050148",
			...
			"tax"                           => array(
				...
				"element"     => array(
					...
					"region"      => array(
						...
						"placeholder" => esc_html__( "Region", 'gshopping-wc-google-shopping' ),
						"type"        => "text",
						"level"       => 1,
						"required"    => false,
						"placeholder" => "MA",
					...
					"postal_code" => array(
						...
						"placeholder" => esc_html__( "Postal code", 'gshopping-wc-google-shopping' ),
						"type"        => "text",
						"level"       => 1,
						"required"    => false,
						"placeholder" => "80302",
